...
- The function name must be "greet"
...
- The function name must be "is_even"
...
- The function name must be "calculate_total"
...
- The function name must be "count_vowels"
...
def run_tests():
    ...
    try:
        res1 = calculate_total(10.0, 2, 21.0) # subtotal 20, +21% = 24.2
        res2 = calculate_total(5.0, 4, 10.0)  # subtotal 20, +10% = 22.0
    ...
    try:
        res1 = count_vowels("Hello World") # e, o, o = 3
        res2 = count_vowels("Programming") # o, a, i = 3
        res3 = count_vowels("AEIOU") # 5 (uppercase test)
        res4 = count_vowels("xyz") # 0
